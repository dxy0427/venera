class Ehentai extends ComicSource {
    ...
    // update url
    url = "https://raw.githubusercontent.com/dxy0427/venera/webdav-comic-source/ehentai.js"
    ...
    translation = {
        ...
        'en_US': {
            ...
            "Yearly": "Yearly",
            "All Time": "All Time",
            "Archive Bot Type": "Archive Bot Type",
    ...
    categoryComics = {
        ranking: {
            ...
            options: [
                "15-" + this.translate("Yesterday"),
                "13-" + this.translate("Monthly"),
                "12-" + this.translate("Yearly"),
                "11-" + this.translate("All Time")
            ],
            /**
             * load ranking comics
